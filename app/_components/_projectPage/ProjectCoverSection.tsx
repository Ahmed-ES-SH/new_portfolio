    ...
    <section className="terminal-module p-1 relative overflow-hidden mb-8 border border-terminal-border bg-background-dark/80 backdrop-blur-sm">
      <div className="h-[400px] md:h-[500px] w-full bg-slate-900 relative group overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 flex flex-col gap-4 z-20">
          <div>
            <h1 className=" text-3xl md:text-5xl font-bold text-white tracking-tighter drop-shadow-md">
              <span className="text-primary mr-2">&gt;</span>
              {project.title[locale].toUpperCase()}
            </h1>
            <p className=" text-primary/70 text-sm md:text-base mt-2 uppercase tracking-widest">
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            {project.projectLink && (
              <a
                ...
                className="px-6 py-2 max-md:w-[80%] bg-sky-500 text-background-dark hover:text-gray-800  font-bold text-sm neon-glow hover:bg-primary transition-all uppercase flex items-center gap-2"
              >
            ...
            {project.linkSourceCode && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-2 max-md:w-[80%]  border-2 border-primary text-primary  font-bold text-sm hover:bg-primary/20 transition-all uppercase flex items-center gap-2"
              >
        ...
        <div className="absolute top-4 right-4 flex gap-2 z-20">
          ...
          <span className="px-2 py-1 bg-primary text-background-dark  text-xs font-bold uppercase">
            {t.badges.online}
          </span>
        </div>
      </div>
