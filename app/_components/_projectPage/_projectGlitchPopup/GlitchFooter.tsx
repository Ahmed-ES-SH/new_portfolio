...
export default function GlitchFooter() {
  return (
    <footer className="h-10 border-t border-primary/30 flex shrink-0 items-center justify-between px-6 bg-black text-[10px] font-mono text-primary/60 relative z-40">
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-primary neon-text tracking-widest">
          DECRYPTING... 65%
        </span>
      </div>
    </footer>
