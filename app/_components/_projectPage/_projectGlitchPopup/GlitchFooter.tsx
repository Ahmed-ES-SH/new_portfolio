...
export default function GlitchFooter() {
  return (
    <footer className="h-10 border-t border-primary/30 flex max-md:flex-col max-md:items-start  shrink-0 items-center justify-between px-6 bg-black text-[10px] font-mono text-primary/60 relative z-40">
