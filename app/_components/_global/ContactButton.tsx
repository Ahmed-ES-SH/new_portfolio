...
export default function ContactButton({ text }: { text: string }) {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isPopupOpen && (
          <div className="fixed w-full h-screen z-9999999 inset-0 flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="bg-primary/10 p-4 border-b border-primary/20 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="md:text-[10px] text-[8px] uppercase font-mono tracking-widest text-primary/80">
                ...
                {/* Content */}
                <div className="p-8 md:p-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 relative z-10">
                  {contactOptions.map((opt) => (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        <div className="text-[10px] font-mono text-primary/40 tracking-tighter">
                          {opt.subLabel}
                        </div>
                      ...
                      <div className="mt-6 flex items-center gap-2 text-[10px] font-mono text-white/50 border-t border-white/5 pt-4 w-full justify-center">
                ...
                <div className="p-2 bg-primary/5 border-t border-white/5 flex justify-center">
                  <div className="text-[8px] font-mono text-white/20 tracking-[0.5em] uppercase">
